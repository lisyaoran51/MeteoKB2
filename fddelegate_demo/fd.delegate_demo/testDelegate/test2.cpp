...
void test2()
{
  ...
  fd::delegate<void (foobar *, int)> dg2;
  dg2 = &foobar::foo;                         // FT02
  ...
  boost::function<void (foobar *, int)> fn2;
  fn2 = &foobar::foo;
  fn2( pfb, 1 );
  // assert( fn2.contains( &foobar::foo ) );

  fd::delegate<void (foobar &, int)> dg3;
  dg3 = &foobar::foo;                         // FT03
  ...
  boost::function<void (foobar &, int)> fn3;
  fn3 = &foobar::foo;
  fn3( fb, 1 );
  // assert( fn3.contains( &foobar::foo ) );

  fd::delegate<void (foobar, int)> dg4;
  dg4 = &foobar::foo;                         // FT04
  ...
  boost::function<void (foobar, int)> fn4;
  fn4 = &foobar::foo;
  fn4( fb, 1 );
  // assert( fn4.contains( &foobar::foo ) );

  fd::delegate<void (boost::shared_ptr<foobar>, int)> dg5;
  dg5 = &foobar::foo;                         // FT04
  ...
  boost::function<void (boost::shared_ptr<foobar>, int)> fn5;
  fn5 = &foobar::foo;
  fn5( spfb, 1 );
