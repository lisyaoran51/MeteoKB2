...
int GameHost::setupConfig()
{
	...
	frameworkConfigManager->Set(FrameworkSetting::SongTitle, string("YourBarClose_Simple"));
	...
	meteorConfigManager->Set(MeteorSetting::FallSpeed, MTO_FLOAT(24.f));	//正常16.f	慢12.f
