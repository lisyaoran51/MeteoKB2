...
int GameHost::setupConfig()
{
	...
	frameworkConfigManager->Set(FrameworkSetting::SongTitle, string("SayNoCry"));
	...
	meteorConfigManager->Set(MeteorSetting::FallSpeed, MTO_FLOAT(12.f));	//正常16.f	慢12.f 目前24 unravel36
