...
int GameHost::setupConfig()
{
	...
	frameworkConfigManager->Set(FrameworkSetting::SongTitle, string("Teenager_Instrumental"));
	...
	meteorConfigManager->Set(MeteorSetting::FallMapAlgorithm, "EruptMapAlgorithm");
