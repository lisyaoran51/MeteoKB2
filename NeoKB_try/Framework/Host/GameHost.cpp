...
int GameHost::updateInitialize()
{
	...
	// 預設是1000
	updateThread->SetMaxUpdateHz(30);
	return 0;
}
...
int GameHost::setupConfig()
{
	...
	frameworkConfigManager->Set(FrameworkSetting::SongTitle, string("DanceMonkey_Simple_ForShooting"));
	...
	meteorConfigManager->Set(MeteorSetting::FallSpeed, MTO_FLOAT(24.f));	//正常16.f	慢12.f 目前24 unravel36
