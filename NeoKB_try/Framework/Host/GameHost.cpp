...
int GameHost::setupConfig()
{
	...
	frameworkConfigManager->Set(FrameworkSetting::SongTitle, string("MeteoMainTheme_Practice"));
	...
	meteorConfigManager->Set(MeteorSetting::FallSpeed, MTO_FLOAT(20.f));	//正常16.f	慢12.f 目前24
