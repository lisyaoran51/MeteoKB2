...
int GameHost::setupConfig()
{
	...
	frameworkConfigManager->Set(FrameworkSetting::SongTitle, string("Gurenge_ForShooting"));
	...
	meteorConfigManager->Set(MeteorSetting::FallSpeed, MTO_FLOAT(44.f));	//正常16.f	慢12.f 目前24 unravel36
