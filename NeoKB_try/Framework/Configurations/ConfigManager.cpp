...
/*
template<typename T>
TConfigManager<T>::TConfigManager(): RegisterType("TConfigManager")
{
...
template<typename T>
int TConfigManager<T>::Set(T lookup, int value)
{
...
template<typename T>
int TConfigManager<T>::Set(T lookup, MTO_FLOAT value)
{
...
template<typename T>
int TConfigManager<T>::Set(T lookup, bool value)
{
...
template<typename T>
int TConfigManager<T>::Set(T lookup, string value)
{
...
template<typename T>
template<typename U>
U TConfigManager<T>::Get(T lookup)
{
...
template<typename T>
template<typename U>
bool TConfigManager<T>::Get(T lookup, U * out)
{
	if (typeid(U) == typeid(int))
	{
...
ConfigManager::ConfigManager() : RegisterType("ConfigManager")
{
}
