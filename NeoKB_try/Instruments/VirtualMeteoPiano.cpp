...
int VirtualMeteoPiano::loadAndMapSamples()
{
	...
	*/
	...
	samplesByPitch[Pitch::C1 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::C1 ), 1);
	samplesByPitch[Pitch::D1b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::D1b), 1);
	samplesByPitch[Pitch::D1 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::D1 ), 1);
	samplesByPitch[Pitch::E1b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::E1b), 1);
	samplesByPitch[Pitch::E1 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::E1 ), 1);
	samplesByPitch[Pitch::F1 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::F1 ), 1);
	samplesByPitch[Pitch::G1b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::G1b), 1);
	samplesByPitch[Pitch::G1 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::G1 ), 1);
	samplesByPitch[Pitch::A1b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::A1b), 1);
	samplesByPitch[Pitch::A1 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::A1 ), 1);
	samplesByPitch[Pitch::B1b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::B1b), 1);
	samplesByPitch[Pitch::B1 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::B1 ), 1);
																   
	samplesByPitch[Pitch::C  ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::C  ), 1);
	samplesByPitch[Pitch::Db ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::Db ), 1);
	samplesByPitch[Pitch::D  ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::D  ), 1);
	samplesByPitch[Pitch::Eb ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::Eb ), 1);
	samplesByPitch[Pitch::E  ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::E  ), 1);
	samplesByPitch[Pitch::F  ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::F  ), 1);
	samplesByPitch[Pitch::Gb ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::Gb ), 1);
	samplesByPitch[Pitch::G  ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::G  ), 1);
	samplesByPitch[Pitch::Ab ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::Ab ), 1);
	samplesByPitch[Pitch::A  ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::A  ), 1);
	samplesByPitch[Pitch::Bb ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::Bb ), 1);
	samplesByPitch[Pitch::B  ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::B  ), 1);
	...
	samplesByPitch[Pitch::c2 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::c2 ), 1);
	samplesByPitch[Pitch::d2b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::d2b), 1);
	samplesByPitch[Pitch::d2 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::d2 ), 1);
	samplesByPitch[Pitch::e2b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::e2b), 1);
	samplesByPitch[Pitch::e2 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::e2 ), 1);
	samplesByPitch[Pitch::f2 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::f2 ), 1);
	samplesByPitch[Pitch::g2b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::g2b), 1);
	samplesByPitch[Pitch::g2 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::g2 ), 1);
	samplesByPitch[Pitch::a2b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::a2b), 1);
	samplesByPitch[Pitch::a2 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::a2 ), 1);
	samplesByPitch[Pitch::b2b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::b2b), 1);
	samplesByPitch[Pitch::b2 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::b2 ), 1);
																   	  
	samplesByPitch[Pitch::c3 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::c3 ), 1);
	samplesByPitch[Pitch::d3b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::d3b), 1);
	samplesByPitch[Pitch::d3 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::d3 ), 1);
	samplesByPitch[Pitch::e3b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::e3b), 1);
	samplesByPitch[Pitch::e3 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::e3 ), 1);
	samplesByPitch[Pitch::f3 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::f3 ), 1);
	samplesByPitch[Pitch::g3b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::g3b), 1);
	samplesByPitch[Pitch::g3 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::g3 ), 1);
	samplesByPitch[Pitch::a3b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::a3b), 1);
	samplesByPitch[Pitch::a3 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::a3 ), 1);
	samplesByPitch[Pitch::b3b] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::b3b), 1);
	samplesByPitch[Pitch::b3 ] = audioManager->GetMirrorSampleManager()->GetSampleChannel(getSoundBinding((int)Pitch::b3 ), 1);
